`ifndef AXI_BRIDGE_SYNC_FIFO_V
`define AXI_BRIDGE_SYNC_FIFO_V
//----------------------------------------------------------------
//  Copyright (c) by Future Design Systems Co., Ltd.
//  All right reserved.
//  http://www.future-ds.com
//----------------------------------------------------------------
// axi_bridge_sync_fifo.v
//----------------------------------------------------------------
// Synchronous FIFO
//----------------------------------------------------------------
// VERSION: 2010.12.13.
...
(
   ...
   assign rd_dout  = (empty) ? {FDW{1'b0}} : Mem[read_addr];
...
// Revision History
//
// 2010.12.13: 'xilinx_dpram' removed by Ando Ki.
